...
<template>
  <section class="bg-teal-700 text-white py-20 px-4 text-center">
    <div class="max-w-3xl mx-auto">
      <h1 class="text-4xl font-bold mb-4">Donnez votre avis sur votre centre de rééducation</h1>
  ...
  <section class="max-w-6xl mx-auto px-4 py-16">
    <h2 class="text-2xl font-bold text-gray-800 mb-8">Centres récents</h2>
    ...
    <div v-else class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        ...
        <p class="text-sm text-gray-500">{{ center.city }} · {{ center.postalCode }}</p>
      </RouterLink>
    </div>
  ...
  <section class="bg-gray-100 py-16 px-4">
    <div class="max-w-4xl mx-auto grid sm:grid-cols-3 gap-8 text-center">
      <div>
        <p class="text-3xl font-bold text-teal-700 mb-2">100%</p>
        <p class="text-gray-600 text-sm">Avis vérifiés par des patients</p>
      </div>
      <div>
        <p class="text-3xl font-bold text-teal-700 mb-2">Gratuit</p>
        <p class="text-gray-600 text-sm">Accès libre pour tous</p>
      </div>
      <div>
        <p class="text-3xl font-bold text-teal-700 mb-2">Anonyme</p>
        <p class="text-gray-600 text-sm">Votre vie privée est protégée</p>
      </div>
    </div>
  </section>
</template>
